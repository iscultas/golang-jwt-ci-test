...
[![CI](https://github.com/iscultas/golang-jwt-ci-test/actions/workflows/ci.yml/badge.svg)](https://github.com/iscultas/golang-jwt-ci-test/actions/workflows/ci.yml)
[![Fuzz](https://github.com/iscultas/golang-jwt-ci-test/actions/workflows/fuzz.yml/badge.svg?event=schedule)](https://github.com/iscultas/golang-jwt-ci-test/actions/workflows/fuzz.yml)
[![Coverage](https://codecov.io/gh/iscultas/golang-jwt-ci-test/branch/trunk/graph/badge.svg)](https://codecov.io/gh/iscultas/golang-jwt-ci-test)

[![Go](https://img.shields.io/github/go-mod/go-version/iscultas/golang-jwt-ci-test?logo=go&color=00ADD8)](https://go.dev/dl/)
[![Dependencies: none](https://img.shields.io/badge/dependencies-none-success)](go.mod)
[![Requirements: 100% of testable](https://img.shields.io/badge/requirements-100%25%20of%20testable-brightgreen)](#requirement-coverage)
...
The [fuzz workflow](.github/workflows/fuzz.yml) does that for each target one time each night,
and not on each change: a run that finds a new input fails the job, and a job that can fail for
a cause outside the change under test is a job that a reader learns to ignore. A target that
finds an input writes it to `testdata/fuzz/`.
