...
const payload = "SXTigJlzIGEgZGFuZ2Vyb3VzIGJ1c2luZXNzLCBGcm9kbywgZ29pbmcgb3V0IHlvdXIgZG9vci4gWW91IHN0ZXAgb250byB0aGUgcm9hZCwgYW5kIGlmIHlvdSBkb24ndCBrZWVwIHlvdXIgZmVldCwgdGhlcmXigJlzIG5vIGtub3dpbmcgd2hlcmUgeW91IG1pZ2h0IGJlIHN3ZXB0IG9mZiB0by4"

type jwsVector struct {
	name          string
	section       string
	key           string
	compact       string
...
var jwsVectors = []jwsVector{
	{
		...
		deterministic: true,
		note:          "RSASSA-PKCS1-v1_5 with SHA-256, deterministic",
	},
	{
		name:          "PS384",
		section:       "4.2",
	...
	},
	{
		...
		deterministic: false,
		note:          "ECDSA using P-521 and SHA-512, randomised k",
	},
	{
		name:          "HS256",
		section:       "4.4",
		key:           "{\"alg\":\"HS256\",\"k\":\"hJtXIZ2uSN5kbQfbtTNWbpdmhkV8FJG-Onbc6mxCcYg\",\"kid\":\"018c0ae5-4d9b-471b-bfd6-eef314bc7037\",\"kty\":\"oct\",\"use\":\"sig\"}",
		compact:       "eyJhbGciOiJIUzI1NiIsImtpZCI6IjAxOGMwYWU1LTRkOWItNDcxYi1iZmQ2LWVlZjMxNGJjNzAzNyJ9.SXTigJlzIGEgZGFuZ2Vyb3VzIGJ1c2luZXNzLCBGcm9kbywgZ29pbmcgb3V0IHlvdXIgZG9vci4gWW91IHN0ZXAgb250byB0aGUgcm9hZCwgYW5kIGlmIHlvdSBkb24ndCBrZWVwIHlvdXIgZmVldCwgdGhlcmXigJlzIG5vIGtub3dpbmcgd2hlcmUgeW91IG1pZ2h0IGJlIHN3ZXB0IG9mZiB0by4.s0h6KThzkfBBBkLspW1h84VsJZFTsPPqMDA7g1Md7p0",
		deterministic: true,
		note:          "HMAC with SHA-256, deterministic",
	},
}
